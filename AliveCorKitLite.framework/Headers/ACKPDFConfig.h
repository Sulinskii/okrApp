...
/**
 *  The forceInvert property would force PDF to ignore AI results of the invert.
 *      null - the default state, SDK will use AI evaluation to determine whether EKG was inverted or not.
 *      true  - forcibly invert EKG in the PDF, and will ignore internal AI evaluation.
 *      false - forcibly ignore evaluation.isInverted() flag and always will draw EKG as it was taken originally.
 */
@property (nonatomic, copy, nullable) NSNumber *forceInvert;
