 ...
 *
 *  @param viewController The view controller that is responsible for the ECG monitoring.
 *  @param heartRate The most recent heart rate value.
 *
 */
- (void)ecgMonitorViewController:(ACKEcgMonitorViewController * _Nonnull)viewController didReceiveHeartRate:(NSInteger)heartRate;
